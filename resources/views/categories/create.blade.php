...
<div class="container-fluid p-4">
  <div class="mb-4">
    <h4 class="fw-semibold"><i class="bi bi-tags me-2 text-primary"></i>Add New Category</h4>
  </div>
      ...
      <div class="card-body p-4">
        <div class="row g-3">
          ...
          <div class="col-md-4">
            ...
            <input type="color" name="badge_color" class="form-control form-control-color" value="{{ old('badge_color', '#03a9f4') }}" title="Choose your color">
          ...
          <div class="col-md-4">
            ...
            <select name="is_featured" class="form-select">
              <option value="0" selected>No (Top Carousel only)</option>
              <option value="1">Yes (Large Card section)</option>
            </select>
          </div>
