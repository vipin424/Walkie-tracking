...
<body>
  <div class="header">
    <div class="company">
      <img src="{{ $company?->logo_absolute_path ?? public_path('image/logo.png') }}" style="width:150px; height:150px; object-fit:contain;" alt="Company Logo">
  ...
  <div class="footer">
    This quotation is computer generated by {{ $company?->name ?? 'Crewrent Enterprises' }}.
  </div>
</body>
</html>